...
class QKVToContextPlugin final : public onnx2trt::PluginV2Ext 
{
public:
    QKVToContextPlugin(
        const std::string name, const int hidden_size, const int num_heads, const int S, const int B, bool has_imask = false);
