...
namespace {
    constexpr const char* SKIPLAYERNORM_PLUGIN_VERSION{"001"};
    constexpr const char* SKIPLAYERNORM_PLUGIN_NAME{"SkipLayerNorm"};
}

class SkipLayerNormPlugin final : public onnx2trt::PluginV2 
{
public:
