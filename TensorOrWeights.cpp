...
nvinfer1::DataType TensorOrWeights::convertONNXDataType(ShapedWeights::DataType datatype)
{
    switch (datatype)
    {
...
ShapedWeights::DataType TensorOrWeights::convertTRTDataType(nvinfer1::DataType datatype)
{
    switch (datatype)
    {
