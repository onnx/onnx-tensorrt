...
Development on this branch is for the TRT EA version of [TensorRT 8.0.0.3](https://developer.nvidia.com/nvidia-tensorrt-download) with full-dimensions and dynamic shape support.
...
### Dependencies
 ...
 - [TensorRT 8.0.0.3](https://developer.nvidia.com/tensorrt)
 - [TensorRT 8.0.0.3 open source libaries (master branch)](https://github.com/NVIDIA/TensorRT/)
...
TensorRT 8.0.0.3 supports ONNX release 1.6.0. Install it with:
